...
logger = logging.getLogger("azure_vm_management")
...
def get_valid_resource_id(prompt, vm_status_data):
    while True:
        ...
        logger.warning("Invalid VM number. Please try again.")
...
def main():
    ...
    while True:
        ...
        if os.path.exists(file_name):
            break
        logger.error(f"Error: File '{file_name}' not found. Please try again.")
    ...
    while True:
        ...
        try:
            ...
            logger.warning("Invalid input. Please enter a number corresponding to the options.")
            continue
        ...
        if choice == 1:  # Scan and View Status
            ...
            while True:
                ...
                try:
                    ...
                    if 1 <= filter_choice <= 3:
                        ...
                        logger.warning("Invalid filter option. Please try again.")
                except ValueError:
            ...
            logger.warning("Invalid option. Please choose a number between 1 and 2.")
